...
const parseMoney = number => parseFloat(number.toFixed(2)); // 1. Створіть функцію getMyTaxes.call(country, salary) -> number; – яка рахує скільки податків ви заплатите як
...
export { random, ukraine }; // console.log(`Завдання 1. getMyTaxes(salary) --> getMyTaxes.call(ukraine, 2000) = `, getMyTaxes.call(ukraine, 2000));
